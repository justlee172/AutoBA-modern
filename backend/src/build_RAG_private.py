...
def preload_retriever(local_engine = True, openai = None, PERSIST_DIR = "../softwares_database_RAG", SOURCE_DIR = "../softwares_database"):
    if not LLAMA_INDEX_AVAILABLE:
        print("[WARNING] llama_index is not available, RAG functionality will be disabled")
        return None
...
def retrive(retriever,
    ...
    if retriever is None:
        return "RAG functionality is disabled. Please install llama-index to enable it."
