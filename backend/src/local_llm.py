...
def api_preload(
    ...
    if not LOCAL_LLM_AVAILABLE:
        print("[WARNING] Local LLM is not available. Please install required dependencies.")
        return None
...
def api_generator(instructions,
    ...
    if not LOCAL_LLM_AVAILABLE or generator is None:
        print("[WARNING] Local LLM is not available. Please install required dependencies.")
        return [{"generation": {"content": "Local LLM is not available. Please install required dependencies."}}]
...
def api_generator_deepseek(instructions,
                  ...
                  top_k = 50,
                  top_p = 0.95):
    if not LOCAL_LLM_AVAILABLE or tokenizer is None or generator is None:
        print("[WARNING] Local LLM is not available. Please install required dependencies.")
        return [{"generation": {"content": "Local LLM is not available. Please install required dependencies."}}]
